...
const TEAM_BADGE_MAP: Record<string, Partial<Record<Disaster, string>>> = {
  ...
  // ── 상황실 ─────────────────────
  // 2026-07-05: 예전엔 '상황실'/'상황실/화재'라는 별도 배지·역할이 disaster_roles에 있었으나,
  // 의미 있는 구분이 아니라고 판단해 각 재난의 일반 '상황' 역할에 그 임무 내용을 병합하고
  // 배지를 '상황'으로 통일함(disa_app 쪽 병합 작업 및 아래 별도 역할 생성 코드 제거와 짝).
  '상황실': {
    화재: '상황', 정전: '상황', 누수: '상황', '태풍/홍수': '상황',
    폭설: '상황', 지진: '상황', 가스누출: '상황', 승강기: '상황', 테러: '상황',
  },
  ...
  '건축파트장': {
    ...
    폭설: '대응1', 지진: '대응2', 가스누출: '대피',
    // 테러: disaster_roles에 '대피' 역할 자체가 없음(2026-07-05 확인) — 배지없음(임무없음)
  },
  ...
  '운영파트장': {
    ...
    폭설: '대응1',
    // 가스누출·지진·테러: disaster_roles에 매칭되는 역할 자체가 없음(2026-07-05 확인) — 배지없음(임무없음)
  },
  '운영파트': {
    화재: '유도', 정전: '지원', 누수: '관리', '태풍/홍수': '지원',
    폭설: '대응1',
    // 가스누출·지진·테러: 배지없음(임무없음)
  },
  ...
  '미화파트': {
    ...
    폭설: '지원1', 지진: '대응1', 가스누출: '대피',
    // 승강기: disaster_roles에 '지원' 역할 자체가 없음(2026-07-05 확인) — 배지없음(임무없음)
    // 테러: 해당없음
  },
  ...
  '주차파트': {
    화재: '유도', 누수: '유도', 테러: '유도',
    // 정전·폭설·지진: disaster_roles에 매칭되는 역할 자체가 없음(2026-07-05 확인) — 배지없음(임무없음)
    // 가스누출: 부서 미확정 — 배지없음(임무없음)
    // 승강기: 해당없음
  },
  ...
  '품질/안전파트': {
    화재: '유도', 폭설: '대응2',
    // 누수: disaster_roles에 '지원' 역할 자체가 없음(2026-07-05 확인) — 배지없음(임무없음)
    // 나머지 재난: 해당없음
  },
};
