...
const TEAM_BADGE_MAP: Record<string, Partial<Record<Disaster, string>>> = {
  ...
  '기계파트장': { 화재:'조치', 정전:'대응', 누수:'응급', '태풍/홍수':'통제', 폭설:'대응2', 지진:'대응1', 가스누출:'통제' },
  '기계파트':   { 화재:'조치', 정전:'대응', 누수:'응급', '태풍/홍수':'대응', 폭설:'대응2', 지진:'대응1', 가스누출:'대응' },
  ...
  '운영파트장': { 화재:'유도', 정전:'지원', 누수:'관리', '태풍/홍수':'지원', 폭설:'대응1', 지진:'지원', 테러:'지원' },
  '운영파트':   { 화재:'유도', 정전:'지원', 누수:'관리', '태풍/홍수':'지원', 폭설:'대응1', 지진:'지원', 테러:'지원' },
  ...
  '주차파트': { 화재:'유도', 정전:'유도', 누수:'유도', '태풍/홍수':'지원', 폭설:'지원3', 지진:'유도', 테러:'유도' },
